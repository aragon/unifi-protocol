...
contract ERC7575Share is ERC20, ERC20Bridgeable, ERC20Burnable, ERC20Permit, IERC7575Share, PausableShare {
    ...
    mapping(address collateralAddress => IERC7575 vaultAddress) internal _vaults;
    ...
    function _checkTokenBridge(address) internal view override auth(TOKEN_BRIDGE_ROLE) {
        return;
    }
