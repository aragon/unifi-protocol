...
pragma solidity >=0.8.29 ^0.8.20 ^0.8.29 ^0.8.8;

// node_modules/@aragon/osx-commons-repo/contracts/src/dao/IDAO.sol
...
interface IERC7575 is IERC165_1 {
...
// src/interfaces/IERC7575Share.sol
...
// src/interfaces/IVaultAllocationStrategy.sol
...
// node_modules/@aragon/osx-commons-repo/contracts/src/permission/auth/auth.sol
...
// node_modules/@openzeppelin/community-contracts/contracts/interfaces/IERC7802.sol

/// @title IERC7802
/// @notice Defines the interface for crosschain ERC20 transfers.
interface IERC7802 is IERC165_0 {
...
// node_modules/@aragon/osx-commons-repo/contracts/src/permission/auth/DaoAuthorizable.sol
...
// src/vault/SingleStrategyManager.sol
...
abstract contract SingleStrategyManager is DaoAuthorizable {
    ...
    function _rebalance() internal returns (uint256 assetsAllocated, uint256 assetsDeallocated) {
        ...
        if (strategyBalance < targetStrategyAmount) {
            ...
            if (amountToInvest > 0) {
                assetsAllocated = _allocate(amountToInvest);
            }
            ...
            if (amountToDivest > 0) {
                assetsDeallocated = _deallocate(amountToDivest);
            }
        }
...
// node_modules/@openzeppelin/community-contracts/contracts/token/ERC20/extensions/ERC20Bridgeable.sol
...
// src/vault/VaultOperatorAuth.sol
...
contract VaultaireVault is VaultAuth, VaultRedeem {
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return interfaceId == type(IERC7540Operator).interfaceId || interfaceId == type(IERC7575).interfaceId
            || interfaceId == type(IERC165_0).interfaceId;
    }
